...
const BannerSlider = () => {
  ...
  <div id="slide1" className="carousel-item relative w-full">
    ...
    <img data-aos="zoom-in-up" data-aos-duration="1000" src="https://media.gettyimages.com/id/1042322938/vector/winter-landscape-oil-painting.jpg?s=612x612&w=0&k=20&c=a4J13msAgHfYZ7QcwFSAM_WEA14e-T1mm_fVDRM7TVY=" className="w-full rounded-lg h-[600px]" />
    <div className='absolute top-[25%] text-center w-full'>
      ...
      <p data-aos="fade-up" data-aos-duration="800" data-aos-delay="1200" className='text-black font-medium pt-5'>The industry involves the buying, selling, and managing of properties for investment or personal use. <br /> It includes residential homes, commercial buildings, and undeveloped land.</p>
      <button data-aos="fade-up" data-aos-duration="800" data-aos-delay="1400" className='text-white mt-6  bg-[#ffcc41] w-[150px] h-[50px] rounded-md font-medium'>More Option</button>
    </div>
    </div>
